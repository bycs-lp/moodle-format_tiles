...
$string['courseshownewactivities'] = 'Highlight tiles with new activities';
$string['courseshownewactivities_help'] = 'Tiles for sections that have new activities since last course login will be highlighted.';
...
$string['editoradvicesubtiles'] = ' In this version of the Tiles plugin ({$a}), activities will only appear as sub-tiles if editing mode is switched off';
